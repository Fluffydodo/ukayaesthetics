...
const Address = () => {
  ...
  return (
    <div className=''>
        <div className='bg-black shadow-lg px-2 py-2 flex justify-between gap-4 items-center '>
        ...
        <div className='bg-black p-2 grid gap-4'>
              {
                addressList.map((address,index)=>{
                  return(
                      <div className={`border rounded p-3 flex gap-3 bg-black ${!address.status && 'hidden'}`}>
